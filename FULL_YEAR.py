    ...
    if selected == 'Analysis':
        ...
        with col1:
            ...
            c = (
                ...
                .set_global_opts(
                    xaxis_opts=pyecharts.options.AxisOpts(axislabel_opts=opts.LabelOpts(rotate=-15)),
                    title_opts=pyecharts.options.TitleOpts(title="Bar-旋转X轴标签", subtitle="解决标签名字过长的问题"),
                )
